...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 dark:from-purple-900 dark:via-blue-900 dark:to-indigo-900 light:from-blue-50 light:via-indigo-50 light:to-purple-50 flex items-center justify-center p-4">
      <div className="text-center glass backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20 dark:border-white/20 light:border-gray-200 animate-scale-in">
        ...
        <div className="flex items-center justify-center mb-4">
          <Loader2 className="h-12 w-12 animate-loading-spin text-purple-400 mr-3" />
